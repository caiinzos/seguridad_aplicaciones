...
public class Constants {
    ...
    public static final String AUTH_INVALID_USER_OR_PASSWORD_MESSAGE = "auth.invalid.user.or.password";
    ...
    public static final String PAY_ORDER_INVALID_PARAMS_MESSAGE = "pay.order.invalid.parameter";
